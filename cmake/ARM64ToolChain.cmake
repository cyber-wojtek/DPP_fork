...
SET(CMAKE_C_COMPILER ${COMPILER_ROOT}/aarch64-linux-gnu-gcc-11)
SET(CMAKE_CXX_COMPILER ${COMPILER_ROOT}/aarch64-linux-gnu-g++-11)
...
SET(ZLIB_LIBRARY /lib/aarch64-linux-gnu/libz.so)
...
EXECUTE_PROCESS(COMMAND sudo apt install -y cmake gcc-11-aarch64-linux-gnu g++-11-aarch64-linux-gnu libc6-dev-arm64-cross zlib1g-dev:arm64)
